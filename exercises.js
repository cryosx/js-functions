...
var difference = substract(bango1, bango2);
...
var myFullName = createFullName("Cyrus", "Wu");
...
console.log(eatFood("Bob", "Miller", "Pasta"));
...
*/
 ...
 console.log(allCaps("this is ats"));
...
function throwParty() {
	return canDrink ? "Cheee Hoo! We going to da party!" : "Meh, see you at Starbucks.";
}
